...
export default class extends Component {   
    ...
    render() {      
        ...
        return ( 
                <div>
                    <div className="brand">
                       <button className="brand-btn" onClick={e => this.setState({show:true})}>新 增 档 次</button>
                    ...
                    </div>
                    {
                        this.state.show
                        &&
                        <Window title='新增档次' onClose={() => this.setState({show:false})} width="230" height='160'>
                    ...
                    }
                     {
                        this.state.show1
                        &&
                        <Window title='修改档次' onClose={() => this.setState({show1:false})} width="230" height='160'>
                            <div className="addbrand-div">
