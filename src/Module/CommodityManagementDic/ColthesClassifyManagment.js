...
export default class extends Component {
    ...
    render() {
        return (
            ...
            <Window title='衣物类别管理' onClose={this.props.closeView} width='632' height='411'>
                {/* 左侧table */}
                ...
                <div className="commodity_classify_management_right">
                    ...
                    <div className='commodity_classify_management_right_bottom clothes_classify_management_btn'>
                        <a>编辑分类</a>
                        <p>分类名称:</p>
