    ...
    render() {
       ...
       return (             
            <Window title='营业统计' onClose={this.props.closeView}>   
                ...
                <div className="Succession-name">衣物件数<b>15248</b>件</div>
                <div className="Succession-name">已为您找到<b>15248</b>条数据</div>
                <div className='businesstats-div businessdaily-div managerquery-div unpaidstatistics_table_part '>                   
                    <table className='businesstats-tab managerquery-tab unpaidstatistics_table_Arrearage table_part '>
                        <thead>
                            <tr>
                                <td>流水号</td>
                                <td>店员姓名</td>
