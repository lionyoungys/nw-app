...
export default class extends Component {   
    ...
    render() {
       ...
       var revokedata_detail = ['流水号','撤单日期','撤单时间','撤单店员','撤单原因','撤单类型','原金额','金额','撤单日期','客户电话','客户姓名','上传'].map((item,index)=><span>{item}</span>)
             ...
             <div className="revokedata">
                   <div className='revokedata_box'>
                      ...
                      <div className="revokedata_list revokedata_last">
                        <div>撤单明细    共记录<b>456</b>条<span className="revokedata_prompt"></span></div>
                        <ul className="revokedata_list_box">
                            <li id="revokedata_list_box_li">
                                <span></span>
                                 {revokedata_detail}
                      ...
                      <div className="revokedata_list revokedata_last">
                        <div>撤单衣物明细    共记录<b>456</b>条<span className="revokedata_prompt"></span></div>
                        <ul className="revokedata_list_box">
                            <li id="revokedata_list_box_li">
                                 <span></span>
                                 {revokedata_clothes}
