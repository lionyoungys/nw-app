...
const Menus = [
    ...
    },
    {
        ...
        options:[
            {value:'经理收款', view:'manager_gathering', id: 32, className:'default'},
            // {value:'经理查询', view:'manager_query', id: 33},
            {value:'营业统计', view:'manager_query', id: 33, className:'default'},
            {value:'经营日报', view:'operate_income', id: 34, className:'default'},
            // {value:'营业统计', view:'Busines_stats', id: 35},
            {value:'经营明细', view:'operating_details', id: 36, className:'default'},
            ...
            {value:'衣物统计', view:'clothe_stat', id: 41, className:'default'},
            {value: '微信、支付宝对账', view:'alipayWechat_checking', id: 42, className:'default'},
        ]
    },
    /*{
        value:'店铺管理', 
